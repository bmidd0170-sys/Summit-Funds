		...
		<div className="intro-container">
			...
			<section className="hero">
				<div className="hero-content">
					...
					<p className="hero-subtitle">
						Personalized budgets that adapt to your life. Quiz on your finances,
						get a smart plan, and reach your goals.
					</p>
			...
			<section className="value-prop">
				<div className="value-card">
					...
					<h3>The Problem</h3>
					<p>
						Expenses keep appearing—emergencies, food, housing. It's hard to
						save when obstacles come your way. You want to build wealth *and*
						enjoy life now.
					</p>
				</div>
				<div className="value-card">
					...
					<h3>Our Solution</h3>
					<p>
						A quick quiz about your finances and life. We build a budget plan
						tailored to you, helping you reach your goals while staying flexible
						for real life.
					</p>
				</div>
			</section>
			...
			<section className="features">
				...
				<div className="features-grid">
					<div className="feature">
						...
						<p>
							Understand your spending habits and financial literacy in 2
							minutes.
						</p>
					</div>
					<div className="feature">
						...
						<p>
							Personalized budget broken down into Essentials, Buffer, and Fun.
						</p>
					</div>
					<div className="feature">
						<div className="feature-icon">🎯</div>
					...
					<div className="feature">
						...
						<p>
							Get recommendations to optimize your spending and save faster.
						</p>
					</div>
					<div className="feature">
						<div className="feature-icon">📱</div>
